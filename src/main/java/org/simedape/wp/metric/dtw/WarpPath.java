...
import org.simedape.wp.metric.matrix.ColMajorCell;
...
public class WarpPath
{
   ...
   public ArrayList getMatchingIndexesForI(int i)
   {
      ...
      while (index<tsIindexes.size() && tsIindexes.get(index).equals(Integer.valueOf(i)))
   ...
   public ArrayList getMatchingIndexesForJ(int j)
   {
      ...
      while (index<tsJindexes.size() && tsJindexes.get(index).equals(Integer.valueOf(j)))
